...
function getGearSuggestionMessage(currentGear, suggestedGear, reason) {
...
export class LocalEventEngine {
    ...
    lastIncidents;
    lastBestLap;
    lastEngineWarnings = 0; // Track engine warning mask
    isInitialized = false; // Track if we've initialized state
    // Coaching state tracking
    lastLateBrakingWarning = 0;
    lastCornerSpeedWarning = 0;
    lastGearSuggestion = 0;
    lastSpeed = 0;
    lastBrake = 0;
    // Corner analysis tracking
    inCorner = false;
    cornerEntrySpeed = 0;
    cornerEntryTooFast = false;
    lastCornerExitFeedback = 0;
    ...
    checkLateBraking(frame, t) {
        ...
        const isLateBraking = speed > LATE_BRAKING_THRESHOLD.minSpeed &&
    ...
    checkCornerSpeed(frame, t) {
        ...
        const isCornerTooFast = isInCorner &&
